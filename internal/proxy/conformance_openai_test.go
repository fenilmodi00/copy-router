	...
	cases := []conformanceCase{
		{
			...
			inbound:         `{"model":"deepseek/deepseek-v4-pro-0813","stream":true,"max_tokens":1024,"messages":[{"role":"user","content":"Say hi."}]}`,
			stream:          true,
			...
			wantUpstream: func(t *testing.T, path string, body []byte, _ http.Header) {
				...
				assert.Equal(t, "deepseek/deepseek-v4-pro-0813", gjson.GetBytes(body, "model").String())
		...
		},
		{
			...
			model:           "deepseek/deepseek-v4-pro-0813",
			newClient:       openRouterClient,
			inbound:         `{"model":"deepseek/deepseek-v4-pro-0813","stream":false,"max_tokens":1024,"messages":[{"role":"user","content":"Say hi."}]}`,
			stream:          false,
		...
		},
		{
			...
			model:           "deepseek/deepseek-v4-pro-0813",
			newClient:       openRouterClient,
			inbound:         `{"model":"deepseek/deepseek-v4-pro-0813","stream":true,"max_tokens":1024,"tools":` + weatherTool + `,"messages":[{"role":"user","content":"Weather in NYC?"}]}`,
			stream:          true,
		...
		},
		{
			...
			model:           "deepseek/deepseek-v4-pro-0813",
			newClient:       openRouterClient,
			inbound:         `{"model":"deepseek/deepseek-v4-pro-0813","stream":true,"max_tokens":1024,"tools":` + weatherTool + `,"messages":[{"role":"user","content":"Run the tool."}]}`,
			stream:          true,
		...
		},
		{
			...
			model:           "deepseek/deepseek-v4-pro-0813",
			newClient:       openRouterClient,
			inbound:         `{"model":"deepseek/deepseek-v4-pro-0813","stream":true,"max_tokens":1024,"system":"You are a helpful assistant.","messages":[{"role":"user","content":"Say hi."}]}`,
			stream:          true,
			upstreamFixture: "openai_chat/basic_text.upstream.sse",
			wantUpstream: func(t *testing.T, _ string, body []byte, _ http.Header) {
		...
		},
		{
			...
			model:           "deepseek/deepseek-v4-pro-0813",
			newClient:       openRouterClient,
			inbound:         `{"model":"deepseek/deepseek-v4-pro-0813","stream":true,"max_tokens":1024,"tools":` + readTool + `,"messages":[{"role":"user","content":"Read a.go"}]}`,
			stream:          true,
